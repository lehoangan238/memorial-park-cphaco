...
export const AerialViewSection = () => {
        ...
        >
          ...
          <div className="text-center mb-8 max-w-4xl mx-auto">
            ...
            <p className="text-slate-600 text-base font-body">
              Chiêm ngưỡng toàn cảnh Hoa Viên Nghĩa Trang Bình Dương từ góc nhìn trên cao
            </p>
          </div>
          ...
          <div className="relative w-full aspect-video rounded-lg overflow-hidden shadow-2xl max-w-none">
            <iframe
              ...
              title="Hoa Viên Bình Dương - Tầm Nhìn Từ Trên Cao"
              frameBorder="0"
