...
/**
 * Unified PlotDetailsPanel component
 * Consolidated from PlotDetailsPanel.tsx and PlotDetailsPanelSupabase.tsx
 */
export function PlotDetailsPanel({ plot, onClose, onStartRouting }: PlotDetailsPanelProps) {
        ...
        <>
          ...
          >
            ...
            <div className="p-4 space-y-6">
              {/* ID and Name */}
              <div>
                <p className="text-xs text-stone-500 uppercase tracking-wide mb-1">Tên vị trí</p>
                <p className="text-lg font-semibold text-stone-900">{plot.name || 'Chưa đặt tên'}</p>
                {plot.zone && (
                  <p className="text-stone-600 mt-1 text-sm">Khu {plot.zone}</p>
                )}
              </div>
